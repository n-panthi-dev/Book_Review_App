                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        ...
                        @if ($book->image != 0)
                            <img src="{{ asset('uploads/books/' . $book->image) }}" alt="Book image"
                                style="width: 400px; height: 500px; object-fit: cover;" class="card-img-top">
                        @else
                            <img src="https://placehold.co/990*1400?text=No Image image" alt="Placeholder image"
                                style="width: 300px; height: 300px; object-fit: cover;" class="card-img-top">
                        @endif
                    </div>
                    @php
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="star-rating d-inline-flex ml-2" title="">
                            ...
                            <span
                                class="theme-font text-muted">({{ $book->reviews_count > 1 ? ' Reviews' : $book->reviews_count . ' Review' }}
                                )</span>
                        </div>
                            ...
                            @if ($relatedBooks->isNotEmpty())
                                @foreach ($relatedBooks as $relatedBook)
                                    <div class="col-md-4 col-lg-4 mb-6">
                                        <div class="card border-0 shadow-lg" style="width: 13rem;">
                                            <a href="{{ route('book.detail', $relatedBook->id) }}">
                                                ...
                                                @else
                                                    <img src="https://placehold.co/990*1400?text=No Image image"
                                            ...
                                            @php
                                                if ($relatedBook->reviews_count > 0) {
                                                    $avgRating =
                                                        $relatedBook->reviews_sum_rating / $relatedBook->reviews_count;
                                                } else {
                                                    $avgRating = 0;
                                                }
                                                $avgRatingPercentage = ($avgRating * 100) / 5;
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h3 class="h4 heading"> <a
                                                        href="{{ route('book.detail', $relatedBook->id) }}"></a>{{ $relatedBook->title }}
                                                </h3>
