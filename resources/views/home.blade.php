                            ...
                            <div class="row">
                                <div class="col-lg-11 col-md-11">
                                    <input type="text" class="form-control form-control-lg"
                                        value="{{ Request::get('keyword') }}" placeholder="Search by title" name="keyword">
                                </div>
                                ...
                                <div class="card border-0 shadow-lg">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="star-rating d-inline-flex ml-2" title="">
                                            ...
                                            <span class="theme-font text-muted">({{($book->reviews_count >1)? ' Reviews':$book->reviews_count.' Review'}} )</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
