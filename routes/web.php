...
Route::group(['prefix' => 'account'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('my-reviews/{id}', [AccountController::class, 'editReview'])->name('account.myreviews.edit');
        Route::post('my-reviews/{id}', [AccountController::class, 'updateReview'])->name('account.myreviews.updateReview');
        Route::post('delete-my-reviews', [AccountController::class, 'deleteReview'])->name('account.myreviews.delete');
    });
});
